        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label>{{ __('messages.field_id_card') }}</label>
                    <input type="text" id="matriculaAlumno" placeholder="{{ __('messages.placeholder_id') }}">
                </div>
                <div class="form-group">
                    <label>{{ __('messages.field_firstname') }}</label>
                    <input type="text" id="nombreAlumno" placeholder="{{ __('messages.placeholder_name') }}">
                </div>
                <div class="form-group">
                    <label>{{ __('messages.field_lastname') }}</label>
                    <input type="text" id="apellidosAlumno" placeholder="{{ __('messages.placeholder_lastname') }}">
                </div>
                <div class="form-group">
                    <label>{{ __('messages.field_group') }}</label>
                ...
                <div class="form-group">
                    ...
                    <input type="email" id="correoAlumno" placeholder="{{ __('messages.placeholder_lastname') }}">
                </div>
            </div>
            <div class="modal-footer">
                <button class="btn-guardar" id="guardarAlumno">{{ __('messages.btn_save') }}</button>
            </div>
        </div>
    </div>
