    ...
    <div id="modalListaGlobal" class="modal-lista-global">
     ...
     <div id="modalRespaldos" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <button type="submit" class="btn-guardar" id="btnRespaldosExec">{{ __('messages.modal_btn_backup_now') }}</button>
                <a href="{{ route("admin.respaldo") }}">
                    <button type="submit" class="btn-guardar" id="btnRespaldosAutoExec">{{ __('messages.modal_btn_backup_auto') }}</button>
                </a>
            </div>
