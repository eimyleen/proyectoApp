...
Route::middleware(['auth'])->group(function () {
    ...
    // --- Ruta para DESCARGAR el PDF con el expediente personal del alumno ---
    Route::get('/dashboard/maestro/descargar-expediente-personal/{alumnoId}', [
